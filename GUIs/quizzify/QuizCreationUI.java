...
// <<<<<<< HEAD
    ...
    /**
     * @param subject the subject for the quiz Creates new form QuizCreationUI
     */
    public QuizCreationUI(String subject, String title) {
  ...
  /**
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> new QuizCreationUI("English", "a subject").setVisible(true));
    }
